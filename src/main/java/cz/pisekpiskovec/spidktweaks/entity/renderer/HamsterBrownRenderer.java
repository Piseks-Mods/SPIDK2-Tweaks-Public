...
@OnlyIn(Dist.CLIENT)
public class HamsterBrownRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HamsterBrownEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelhamster(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("piseks_spidk_ii_tweaks:textures/entities/hamster_brown.png");
					}
				};
			});
		}
