...
import cz.pisekpiskovec.spidktweaks.entity.OwlEntity;
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(OwlEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelowl(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("piseks_spidk_ii_tweaks:textures/entities/owl.png");
					}
				};
			});
		}
