...
public class SpicebushBranchAttackMagnificentSpringBreezeProcedure {

	public static ActionResultType executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PiseksSpidkIiTweaksMod.LOGGER.warn("Failed to load dependency entity for procedure SpicebushBranchAttackMagnificentSpringBreeze!");
			return ActionResultType.PASS;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				PiseksSpidkIiTweaksMod.LOGGER
						.warn("Failed to load dependency sourceentity for procedure SpicebushBranchAttackMagnificentSpringBreeze!");
			return ActionResultType.PASS;
		}
