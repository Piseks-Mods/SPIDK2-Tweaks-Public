...
public class StrippedEmberwoodStemBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:stripped_emberwood_stem")
	public static final Block block = null;

	public StrippedEmberwoodStemBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_emberwood_stem");
		}
