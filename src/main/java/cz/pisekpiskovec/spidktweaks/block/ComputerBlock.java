...
public class ComputerBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:computer")
	public static final Block block = null;
	@ObjectHolder("piseks_spidk_ii_tweaks:computer")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ComputerBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 144);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("computer"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ANVIL, MaterialColor.IRON).sound(SoundType.METAL).hardnessAndResistance(5f, 6f)
