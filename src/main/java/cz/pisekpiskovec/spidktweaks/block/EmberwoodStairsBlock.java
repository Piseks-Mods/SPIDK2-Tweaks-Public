...
public class EmberwoodStairsBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:emberwood_stairs")
	public static final Block block = null;

	public EmberwoodStairsBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("emberwood_stairs");
		}
