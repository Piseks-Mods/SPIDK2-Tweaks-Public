...
import cz.pisekpiskovec.spidktweaks.procedures.DecayedPodzolSpawnProcedure;
import cz.pisekpiskovec.spidktweaks.PiseksSpidkIiTweaksModElements;

@PiseksSpidkIiTweaksModElements.ModElement.Tag
public class DecayedPodzolBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:decayed_podzol")
	public static final Block block = null;

	public DecayedPodzolBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("decayed_podzol");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			DecayedPodzolSpawnProcedure.executeProcedure(Stream
