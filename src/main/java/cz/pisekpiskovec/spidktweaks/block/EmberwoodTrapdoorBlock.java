...
public class EmberwoodTrapdoorBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:emberwood_trapdoor")
	public static final Block block = null;

	public EmberwoodTrapdoorBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("emberwood_trapdoor");
		}
