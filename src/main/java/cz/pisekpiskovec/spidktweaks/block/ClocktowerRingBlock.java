...
public class ClocktowerRingBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:clocktower_ring")
	public static final Block block = null;

	public ClocktowerRingBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_BLUE)
					.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("block.glass.break")),
							...
							() -> new SoundEvent(new ResourceLocation("block.beacon.ambient")),
							() -> new SoundEvent(new ResourceLocation("block.stone.hit")),
							() -> new SoundEvent(new ResourceLocation("block.stone.fall"))))
					.hardnessAndResistance(6f, 24f).setLightLevel(s -> 7).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(WATERLOGGED, false));
			setRegistryName("clocktower_ring");
		}
