...
public class EmberwoodSlabBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:emberwood_slab")
	public static final Block block = null;

	public EmberwoodSlabBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("emberwood_slab");
		}
