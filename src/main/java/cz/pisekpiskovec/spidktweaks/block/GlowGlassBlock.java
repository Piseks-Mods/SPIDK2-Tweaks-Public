...
public class GlowGlassBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:glow_glass")
	public static final Block block = null;

	public GlowGlassBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 473);
	}
