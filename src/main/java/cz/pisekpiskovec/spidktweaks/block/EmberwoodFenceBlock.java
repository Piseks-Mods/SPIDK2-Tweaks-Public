...
public class EmberwoodFenceBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:emberwood_fence")
	public static final Block block = null;

	public EmberwoodFenceBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("emberwood_fence");
		}
