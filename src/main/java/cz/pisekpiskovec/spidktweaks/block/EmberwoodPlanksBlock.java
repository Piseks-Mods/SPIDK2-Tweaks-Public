...
public class EmberwoodPlanksBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:emberwood_planks")
	public static final Block block = null;

	public EmberwoodPlanksBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("emberwood_planks");
		}
