...
public class StrippedEmberwoodHyphaeBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:stripped_emberwood_hyphae")
	public static final Block block = null;

	public StrippedEmberwoodHyphaeBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_emberwood_hyphae");
		}
