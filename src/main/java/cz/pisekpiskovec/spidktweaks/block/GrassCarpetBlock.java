...
public class GrassCarpetBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:grass_carpet")
	public static final Block block = null;

	public GrassCarpetBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 48);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CARPET, MaterialColor.GRASS).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0).harvestLevel(0).harvestTool(ToolType.HOE).notSolid().setOpaque((bs, br, bp) -> false));
