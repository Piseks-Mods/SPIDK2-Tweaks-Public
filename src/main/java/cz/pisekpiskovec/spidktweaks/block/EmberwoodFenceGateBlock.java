...
public class EmberwoodFenceGateBlock extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:emberwood_fence_gate")
	public static final Block block = null;

	public EmberwoodFenceGateBlock(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("emberwood_fence_gate");
		}
