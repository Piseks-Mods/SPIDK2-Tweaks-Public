...
public class HealingBedHungerGameRule extends PiseksSpidkIiTweaksModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.IntegerValue> gamerule = GameRules.register("healingBedHunger", GameRules.Category.PLAYER,
			create(6));

	public HealingBedHungerGameRule(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 356);
	}
