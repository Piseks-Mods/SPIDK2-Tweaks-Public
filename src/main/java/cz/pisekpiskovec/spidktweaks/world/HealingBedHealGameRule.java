...
public class HealingBedHealGameRule extends PiseksSpidkIiTweaksModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.IntegerValue> gamerule = GameRules.register("healingBedHeal", GameRules.Category.PLAYER,
			create(15));

	public HealingBedHealGameRule(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 354);
	}
