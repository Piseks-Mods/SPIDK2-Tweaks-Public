...
public class HealingRuneEffectStrenghtGameRule extends PiseksSpidkIiTweaksModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.IntegerValue> gamerule = GameRules.register("healingRuneEffectStrenght", GameRules.Category.MOBS,
			create(1));

	public HealingRuneEffectStrenghtGameRule(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 309);
	}
