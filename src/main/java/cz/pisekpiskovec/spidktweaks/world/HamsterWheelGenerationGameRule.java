...
public class HamsterWheelGenerationGameRule extends PiseksSpidkIiTweaksModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.IntegerValue> gamerule = GameRules.register("hamsterWheelGeneration", GameRules.Category.MISC,
			create(200));

	public HamsterWheelGenerationGameRule(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 407);
	}
