...
public class HealingBedBonusDividerGameRule extends PiseksSpidkIiTweaksModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.IntegerValue> gamerule = GameRules.register("healingBedBonusDivider", GameRules.Category.PLAYER,
			create(3));

	public HealingBedBonusDividerGameRule(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 355);
	}
