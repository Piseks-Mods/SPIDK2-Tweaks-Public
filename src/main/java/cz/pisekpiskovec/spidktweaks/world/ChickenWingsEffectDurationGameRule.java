...
public class ChickenWingsEffectDurationGameRule extends PiseksSpidkIiTweaksModElements.ModElement {
	public static final GameRules.RuleKey<GameRules.IntegerValue> gamerule = GameRules.register("chickenWingsEffectDuration",
			GameRules.Category.PLAYER, create(10));

	public ChickenWingsEffectDurationGameRule(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 312);
	}
