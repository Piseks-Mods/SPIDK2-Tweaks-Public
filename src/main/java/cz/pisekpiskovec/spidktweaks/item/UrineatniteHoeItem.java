...
public class UrineatniteHoeItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:urineatnite_hoe")
	public static final Item block = null;

	public UrineatniteHoeItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 480);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("urineatnite_hoe"));
	}
}
