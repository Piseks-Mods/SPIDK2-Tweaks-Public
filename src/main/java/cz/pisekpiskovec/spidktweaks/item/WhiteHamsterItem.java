...
import cz.pisekpiskovec.spidktweaks.procedures.WhiteHamsterReleaseProcedure;
import cz.pisekpiskovec.spidktweaks.PiseksSpidkIiTweaksModElements;

@PiseksSpidkIiTweaksModElements.ModElement.Tag
public class WhiteHamsterItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:white_hamster")
	public static final Item block = null;

	public WhiteHamsterItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 101);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			WhiteHamsterReleaseProcedure.executeProcedure(Stream
