...
public class UmbrellaItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:umbrella")
	public static final Item block = null;

	public UmbrellaItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 1);
	}
