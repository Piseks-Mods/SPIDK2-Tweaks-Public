...
import cz.pisekpiskovec.spidktweaks.procedures.GingerHamsterReleaseProcedure;
import cz.pisekpiskovec.spidktweaks.PiseksSpidkIiTweaksModElements;

@PiseksSpidkIiTweaksModElements.ModElement.Tag
public class GingerHamsterItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:ginger_hamster")
	public static final Item block = null;

	public GingerHamsterItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 100);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ginger_hamster");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			GingerHamsterReleaseProcedure.executeProcedure(Stream
