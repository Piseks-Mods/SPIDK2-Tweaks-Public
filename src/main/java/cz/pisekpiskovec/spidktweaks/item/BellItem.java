...
import cz.pisekpiskovec.spidktweaks.procedures.BellRingProcedure;
...
public class BellItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:bell")
	public static final Item block = null;

	public BellItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 65);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			BellRingProcedure.executeProcedure(Stream
