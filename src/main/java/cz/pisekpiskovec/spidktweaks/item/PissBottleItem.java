...
public class PissBottleItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:piss_bottle")
	public static final Item block = null;

	public PissBottleItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 474);
	}
