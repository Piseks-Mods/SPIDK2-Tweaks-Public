...
public class ChromaticIngotItem extends PiseksSpidkIiTweaksModElements.ModElement {
	@ObjectHolder("piseks_spidk_ii_tweaks:chromatic_ingot")
	public static final Item block = null;

	public ChromaticIngotItem(PiseksSpidkIiTweaksModElements instance) {
		super(instance, 115);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("chromatic_ingot");
		}
